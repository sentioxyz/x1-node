...
import (
	...
	"github.com/okx/zkevm-node/test/contracts/bin/BridgeA"
	"github.com/okx/zkevm-node/test/contracts/bin/BridgeB"
	"github.com/okx/zkevm-node/test/contracts/bin/BridgeC"
	"github.com/okx/zkevm-node/test/contracts/bin/BridgeD"
	"github.com/okx/zkevm-node/test/contracts/bin/Called"
	"github.com/okx/zkevm-node/test/contracts/bin/Caller"
	"github.com/okx/zkevm-node/test/contracts/bin/ChainCallLevel1"
	"github.com/okx/zkevm-node/test/contracts/bin/ChainCallLevel2"
	"github.com/okx/zkevm-node/test/contracts/bin/ChainCallLevel3"
	"github.com/okx/zkevm-node/test/contracts/bin/ChainCallLevel4"
	"github.com/okx/zkevm-node/test/contracts/bin/Counter"
	"github.com/okx/zkevm-node/test/contracts/bin/Creates"
	"github.com/okx/zkevm-node/test/contracts/bin/Depth"
	"github.com/okx/zkevm-node/test/contracts/bin/ERC20"
	"github.com/okx/zkevm-node/test/contracts/bin/EmitLog"
	"github.com/okx/zkevm-node/test/contracts/bin/Memory"
	"github.com/okx/zkevm-node/test/contracts/bin/OpCallAux"
	"github.com/okx/zkevm-node/test/contracts/bin/Revert2"
