...
import (
	...
	"github.com/okx/zkevm-node/test/contracts/bin/EmitLog2"
	"github.com/okx/zkevm-node/test/contracts/bin/FailureTest"
	"github.com/okx/zkevm-node/test/contracts/bin/Read"
