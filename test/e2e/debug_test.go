...
func TestDebugTraceBlock(t *testing.T) {
	...
	testCases := []testCase{
		...
		// {name: "erc20 transfer by number", blockNumberOrHash: "number", prepare: prepareERC20Transfer, createSignedTx: createERC20TransferSignedTx},  //TODO need rebuild fork6 e2e image
		// by block hash
