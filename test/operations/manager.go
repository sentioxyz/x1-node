...
var (
	...
	executorURI      = testutils.GetEnv(constants.ENV_ZKPROVER_URI, "xgon-prover:50071")
	merkleTreeURI    = testutils.GetEnv(constants.ENV_MERKLETREE_URI, "xgon-prover:50061")
